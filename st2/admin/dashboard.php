      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li <?php if (isset($_GET['page']) && $_GET['page'] == 'kandidatrw') { echo 'class="active"'; } ?>>
                <a href="?page=kandidatrw"><i class="fa fa-users"></i> <span>Manajemen Kandidat RW</span></a>
            </li>
            <li <?php if (isset($_GET['page']) && $_GET['page'] == 'kandidat') { echo 'class="active"'; } ?>>
                <a href="?page=kandidat"><i class="fa fa-users"></i> <span>Manajemen Kandidat RT</span></a>
            </li>
            <li <?php if (isset($_GET['page']) && $_GET['page'] == 'kelas') { echo 'class="active"'; } ?>>
                <a href="?page=kelas"><i class="fa fa-university"></i> <span>Manajemen Warga</span></a>
            </li>
...
<?php
    if (isset($_GET['page']) && $_GET['page'] == 'kandidatrw') { ?>
      function tampil() {
          $.ajax({
            url: 'ajaxrw.php',
            method: "GET",
