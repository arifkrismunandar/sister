...
<div class="row">
    <div class="col-md-8">
        <form action="./kandidatrw/simpan.php" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="form-group" style="padding-top:20px;">
                <div class="col-md-offset-3 col-md-8">
                    <button type="submit" name="add_kandidatrw" value="Tambah Kandidat" class="btn btn-success">
                        Tambah Kandidat
                    </button>
