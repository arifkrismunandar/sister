...
$id   = $_GET['id'];
$sql  = $con->prepare("SELECT * FROM t_kandidatrw WHERE id_kandidatrw = ?") or die($con->error);
$sql->bind_param('i', $id);
$sql->execute();
$sql->store_result();
...
<div class="row">
   <div class="col-md-3">
      <div class="callout text-center">
         <img src="../assets/img/kandidatrw/<?php echo $foto; ?>" class="img-responsive"/>
      </div>
   </div>
   <div class="col-md-8">
        <form action="./kandidatrw/update.php" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="form-group" style="padding-top:20px;">
                <div class="col-md-8 col-md-offset-3">
                    <button type="submit" name="update" value="Update Kandidatrw" class="btn btn-success">
                        Update Kandidat
                    </button>
