...
<html>
   ...
   <body>
      <div class="container">
         ...
         if ($sql->num_rows() > 0) {
            ...
            echo '<div class="text-center" style="padding-top:20px;">
                     <h2>Daftar Calon Ketua RT '.$periode.'</h2>
                  </div>
                  <hr />';
      ...
      <div class="container">
         ...
         $sql = $con->prepare("SELECT * FROM t_kandidatrw WHERE perioderw = ?") or die($con->error);
         $sql->bind_param('s', $periode);
         $sql->execute();
         $sql->store_result();
         if ($sql->num_rows() > 0) {
            $numb = $sql->num_rows();
            echo '<div class="text-center" style="padding-top:20px;">
                     <h2>Daftar Calon Ketua Rw '.$periode.'</h2>
                  </div>
                  <hr />';
         ...
         ?>
                  <div class="col-md-3">
                    <section class="wow fadeInDown" data-wow-delay="<?php echo $i; ?>s">
                      <div class="thumbnail">  
                        <div class="text-center">
                           <img src="./assets/img/kandidatrw/<?php echo $foto; ?>" class="img">
                           <p class="nama"><?php echo $nama; ?></p>
                           <div class="caption">
                              <a href="./detail.php?id=<?php echo $id; ?>" class="btn btn-warning btn-block">Lihat Visi Misi</a>
                              <a href="./submit.php?id=<?php echo $id; ?>&s=<?php echo $suara; ?>" class="btn btn-success btn-block">Beri Suara</a>
